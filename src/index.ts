...
if (isSimulate) {
  ...
  console.log(`${player1.name}: attack = ${player1.attackPower}, defense = ${player1.defensePower}, ability = ${player1.ability.name}`);
  console.log(`${player2.name}: attack = ${player2.attackPower}, defense = ${player2.defensePower}, ability = ${player2.ability.name}`);
  console.log('');
